...
helper._set_mock_rsi_credentials = () => {
  paramStore[process.env.SSM_PARAM_NS + '/CLIENT_ID'] = {
    Parameter: {
      Name: process.env.SSM_PARAM_NS + '/CLIENT_ID',
      Value: 'MOCK_CLIENT_ID',
      Type: 'String'
    }
  }
  paramStore[process.env.SSM_PARAM_NS + '/CLIENT_SECRET'] = {
    Parameter: {
      Name: process.env.SSM_PARAM_NS + '/CLIENT_SECRET',
      Value: 'MOCK_CLIENT_SECRET',
      Type: 'String'
    }
  }
  paramStore[process.env.SSM_PARAM_NS + '/CLIENT_GRANT_TYPE'] = {
    Parameter: {
      Name: process.env.SSM_PARAM_NS + '/CLIENT_GRANT_TYPE',
      Value: 'MOCK_CLIENT_GRANT_TYPE',
      Type: 'String'
    }
  }
  paramStore[process.env.SSM_PARAM_NS + '/CLIENT_USER_NAME'] = {
    Parameter: {
      Name: process.env.SSM_PARAM_NS + '/CLIENT_USER_NAME',
      Value: 'MOCK_CLIENT_USER_NAME',
      Type: 'String'
    }
  }
  paramStore[process.env.SSM_PARAM_NS + '/CLIENT_PASSWORD'] = {
    Parameter: {
      Name: process.env.SSM_PARAM_NS + '/CLIENT_PASSWORD',
      Value: 'MOCK_CLIENT_PASSWORD',
      Type: 'String'
    }
  }
}

helper._set_mock_rsi_access_token = (token) => {
  paramStore[process.env.SSM_PARAM_NS + '/RSI_ACCESS_TOKEN'] = {
    Parameter: {
      Name: process.env.SSM_PARAM_NS + '/RSI_ACCESS_TOKEN',
      Value: token,
      Type: 'String'
    }
  }
